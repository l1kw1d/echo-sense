...
app = webapp2.WSGIApplication(
     [
      ...
      webapp2.Route('/api/analysis/multi/<akn_list>', handler=api.AnalysisAPI, handler_method="detail_multi", methods=["GET"], name="AnalysisAPI"),
      webapp2.Route('/api/analysis/multi', handler=api.AnalysisAPI, handler_method="update_multi", methods=["POST"], name="AnalysisAPI"),
      webapp2.Route('/api/analysis', handler=api.AnalysisAPI, handler_method="update", methods=["POST"], name="AnalysisAPI"),
      ...
      webapp2.Route('/api/payment', handler=api.PaymentAPI, handler_method="send", methods=["POST"]),
